            ...
            Stack(
              children: [
                ...
                Positioned(top: 60,
                    right: 85,
                    left: 85,
                    child: Center(child: Text('تبحث الان عن ميكانيكي في',style: TextStyle(fontSize: 22,color: Colors.black),))),
                Positioned(right: 5,
                    top: 70,
                ...
                children: [
                      ...
                      Column(
                        children: [
                          Padding(
                            ...
                            child: Text('مختار عطية ',style: TextStyle(fontSize: 18),),
                          ),
                  ...
                  Padding(
                    ...
                    child: Row(children: [
                      ...
                      Container(height: 60,
                        width: 265,
                        child:Text(' ميكانيكي سيارات وتصليح عفشة وتغيير زيت وشكمانات ',style: TextStyle(fontSize: 16),textAlign:TextAlign.right),
                      ),
                      Padding(
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          Padding(
                            padding: const EdgeInsets.only(left: 85),
                            child: Text('عبدالحي حسنين ',style: TextStyle(fontSize: 18),),
                          ),
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          Padding(
                            padding: const EdgeInsets.only(left: 85),
                            child: Text('اسماعيل عبده ',style: TextStyle(fontSize: 18),),
                          ),
