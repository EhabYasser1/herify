...
class Sbak extends StatefulWidget {
  const Sbak({Key? key}) : super(key: key);

  @override
  State<Sbak> createState() => _SbakState();
}

class _SbakState extends State<Sbak> {
  @override
            ...
            Stack(
              children: [
                ...
                const Positioned(top: 60,
                    right: 85,
                    left: 85,
                    child: Center(child: Text('تبحث الان عن سباك في',
                ...
                children: [
                      ...
                      Column(
                        children: [
                          const Padding(
                            ...
                            child: Text('محمد عبدالرحيم ', style: TextStyle(fontSize: 18),),
                          ),
                  ...
                  Padding(
                    ...
                    child: Row(children: [
                      ...
                      Container(height: 60,
                        width: 265,
                        child: const Text(' سباك متخصص في صيانة و تركيبات وصلات المياه ', style: TextStyle(fontSize: 16), textAlign: TextAlign.right),
                      ),
                      Padding(
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          const Padding(
                            padding: EdgeInsets.only(left: 85),
                            child: Text('عبدالحي حسنين ',
                              style: TextStyle(fontSize: 18),),
                          ),

                          Row(children: [

                            const Text('من 150 عميل',
                              style: TextStyle(fontSize: 14, color: Color(
                                  0xB5000000)),),
                            const Icon(Icons.star_border),
                            const Icon(Icons.star_outline, color: Color(0xFF893F04)),
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          const Padding(
                            padding: EdgeInsets.only(left: 85),
                            child: Text('إسماعيل عبده  ', style: TextStyle(fontSize: 18),),
                          ),
